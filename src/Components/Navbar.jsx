...
import Resume from '../Resume/Vedant-Resume.pdf'
    ...
    return (
        <Box className='navbar'>
            ...
            <Box display={["none", 'none', 'none', 'flex']} className="nav-options">
                ...
                <Box>
                    <Button onClick={()=>{window.open("https://drive.google.com/file/d/1I-1wqawYsO8q4EmnnHiGiRLB5-yDUp-F/view?usp=sharing", '_blank')}}><a href={Resume} download=""><span>Resume</span></a></Button>
                </Box>
                <Box>
